//
// Created by lugang on 2022/5/22.
//

#ifndef CONCURRENT_BPLUSTREE_BPLUSTREE_H
#define CONCURRENT_BPLUSTREE_BPLUSTREE_H
#include <cstring>
#include <functional>
#include <iostream>
#include <list>
...
public:
    ...
    public:
         ...
         */
        SharedLatch *GetLatchPointer() { return &(metadata_.node_latch_); }
    ...
    bool Insert(const KeyElementPair element, std::function<bool(const ValueType)> predicate) {
        ...
        */
        ...
        while (current_node->GetType() != NodeType::LeafType) {
            ...
            //从上往下进行预判，如果到这一层不会分裂，直接将现在所有的锁进行删除
...
#endif //CONCURRENT_BPLUSTREE_BPLUSTREE_H
